...
RSpec.describe Enrollment::DgfipsController, type: :controller do
  let(:uid) { 1 }
    ...
    describe 'with a service_provider user' do
      ...
      context 'with valid params' do
        it 'creates a new Enrollment' do
          ...
          expect do
            post :create, params: { enrollment: valid_attributes }
          end.to change(Enrollment::Dgfip, :count).by(1)
        end
        ...
        it 'renders a JSON response with the new enrollment' do
          ...
          expect(response.location).to eq(enrollment_dgfip_url(Enrollment::Dgfip.last))
        end

        it 'user id applicant of enrollment' do
          post :create, params: { enrollment: valid_attributes }

          expect(user.has_role?(:applicant, Enrollment::Dgfip.last)).to be_truthy
        end
      end
      ...
      describe 'with a valid schema' do
        ...
        it "creates an enrollment with all data" do
          ...
          enrollment = Enrollment::Dgfip.last
      ...
      describe 'with a service_provider user' do
        ...
        describe 'user is applicant of enrollment' do
          ...
          it 'updates the requested enrollment' do
            ...
            enrollment.reload
            expect(enrollment.scope_dgfip_RFR).to be_truthy
          end
      ...
      describe 'with a service_provider user' do
        ...
        describe 'user is applicant of enrollment' do
          ...
          describe 'enrollment can be sent' do
            let(:enrollment) { FactoryGirl.create(:sent_enrollment_dgfip, state: :pending) }
