...
class Enrollment < ApplicationRecord
  ...
  def agreements_validation
    ...
    errors[:validation_delegue_a_la_protection_des_données] << "Le Délégué à la protection des données doit avoir pris connaissance de la démarche avant de continuer" unless validation_delegue_a_la_protection_des_données?
  end
end
